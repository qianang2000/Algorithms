...
public class SCUtility {
    ...
    public static void main(String[] args) {
        SCUtility scu = new SCUtility();
        Picture rand = scu.randomPicture(100, 80);
        SeamCarver sc = new SeamCarver(rand);
        // scu.showEnergy(sc);
        Picture energy = toEnergyPicture(sc);
        // energy.show();
        int[] seamVertical = sc.findVerticalSeam();
        int[] seamHorizontal = sc.findHorizontalSeam();
        Picture vertical = scu.seamOverlay(rand, false, seamVertical);
        Picture horizontal = scu.seamOverlay(rand, true, seamHorizontal);
        // vertical.show();
        horizontal.show();
    }
